                            ...
                            <div className='tabMobRes col-12'>
                                        ...
                                        <div className='container'>
                                            <div className='form-lng'>
                                                <div className='dropdown'>
                                                    <button id='dropdown-basic' aria-expanded='false' type='button' className='btn dropdown-toggle dropdown-toggle btn btn-none'>
                                                        ...
                                                        <div className="position-relative mb-4 col-md-6 col-12">
                                                            <div className="input-group has-validation">
                                                                ...
                                                                <input
                                                                    ...
                                                                    onChange={input1}
                                                                />
                                                                <div className="invalid-tooltip">Phone is required</div>
                                                            </div>
                                                        </div>
                                                        <div className="position-relative mb-4 col-md-6 col-12">
                                                            <input
                                                    ...
                                                    <div className="row">
                                                        <div className="position-relative mb-4 col-md-6 col-12">
                                                            <div className="input-group has-validation">
                                                                ...
                                                                <div className="invalid-tooltip">Enter your password</div>
                                                            </div>
                                                        </div>
                                                        <div className="position-relative mb-4 col-md-6 col-12">
                                                            <div className="input-group has-validation">
                                                                ...
                                                                <div className="invalid-tooltip">Enter confirm password</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="mb-4 row">
                                                        <div className="col-12">
                                                            <div className="d-flex align-items-center justify-content-start pin-area">
                                                                ...
                                                                />
                                                                <div className="invalid-tooltip">PIN must be entered</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="row">
                                                            ...
                                                            <div mb="3" className="position-relative col">
                                                                <div className="form-check">
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <a
                                                                            href="https://www.accuindex.com/legal-documents" target="_blank">
                                                                            privacy policy
                                                                        </a></label>
                                                                    <div className="invalid-tooltip">Accept Terms &amp; Conditions is required</div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <form className="">
                                                    ...
                                                    <div className="mb-3 row">
                                                        <div className="position-relative mb-3 col">
                                                            <label className="form-label">Password<sup>*</sup>
                                                            </label>
                                                            <div className="input-group has-validation">
                                                                <input
                                                                    type="password"
                                                    ...
                                                    <div className="mb-3 row">
                                                        <div className="mb-2 col-12"><button type="submit" className="btn btn-primary">
                                                            Login
                                                        </button>
                                                        </div>
                                                    </div>
                                    ...
                                    <div className="col-xl-4 col-md-4">
                                        <div className="entityAccu">
                                            ...
                                            <select name="type" type="text">
                                                ...
                                                <option value="Accuindex EU CySEC">Accuindex EU CySEC</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div className="row">
                                    ...
                                    <div className="accuContent">
                                        <div>
                                            <p>
                                                Accuindex Limited is an Investment Firm incorporated under number 167867 in the Republic of
                                                Mauritius. Authorized and regulated by the Financial Service Commission ( FSC ) in Mauritius (License
                                                No GB19024778 ). Registered address at The Cyberati Lounge, Ground Floor, The Catalyst, Silicon
