...
import { Button, CardContent, Checkbox, FormControl, FormControlLabel, Grid, InputLabel, MenuItem, Paper, Select, TextField } from "@mui/material";
...
const FAQEditor = () => {
    ...
    const column = [
        ...
        {
            name: 'ANSWER',
            selector: row => { return <span title={row.answer}>{row.answer}</span> },
            sortable: true,
            reorder: true,
            wrap: true,
            grow: 1,
        ...
        if (dialogTitle == 'Add FAQ') {
            return <div>
                <div className='margeField'>
                    <TextField label="Question" variant="standard" sx={{ width: '100%' }} name='question' onChange={input} />
                </div>
                <br />
                <div className='margeField'>
                    <TextField multiline label="Answer" variant="standard" sx={{ width: '100%' }} name='answer' onChange={input} />
                </div>
                <br />
                <div className='margeField'>
                    <TextField label="Order" variant="standard" sx={{ width: '100%' }} name='order' onChange={input} />
                    <FormControlLabel
                        control={
            ...
            return <div>
                <div className='margeField'>
                    <TextField label="Question" variant="standard" sx={{ width: '100%' }} name='question' value={form.question} onChange={input} />
                </div>
                <br />
                <div className='margeField'>
                    <TextField multiline label="Answer" variant="standard" sx={{ width: '100%' }} name='answer' value={form.answer} onChange={input} />
                </div>
                <br />
                <div className='margeField'>
                    <TextField label="Order" variant="standard" sx={{ width: '100%' }} name='order' value={form.order} onChange={input} />
                    <FormControlLabel
                        control={
                            // <Checkbox checked={true} name="declaration" size="small"/>
    ...
    const manageDialogActionButton = () => {
        if (dialogTitle == 'Add FAQ' || dialogTitle == 'Edit FAQ') {
            return <div className='dialogMultipleActionButton'>
                ...
                {(form.isLoader == true) ? <Button variant="contained" className='btn-gradient btn-success' disabled><svg class="spinner" viewBox="0 0 50 50">
                          <circle class="path" cx="25" cy="25" r="20" fill="none" stroke-width="5"></circle>
                        </svg></Button> : <Button variant="contained" className='btn-gradient btn-success' onClick={formSubmit}>Add</Button>}
