                          ...
                          <Grid item md={12}>
                            <form>
                              <Grid container spacing={3}>
                                ...
                                {/* <Grid item md={6} className="accountInfoGrid">
                                  <div>
                                    <span className="fw-700">Book Profit</span>{" "}
                                  </div>
                                  <div>{mt5AndDemoList.value?.book_profit}</div>
                                </Grid>{" "}
                                <Grid item md={6} className="accountInfoGrid">
                                  <div>
                                    <span className="fw-700">
                                  ...
                                  <div>
                                    {mt5AndDemoList.value?.total_deposit}
                                  </div>
                                </Grid>{" "}
                                <Grid item md={6} className="accountInfoGrid">
                                  <div>
                                    <span className="fw-700">Swap</span>{" "}
                                  </div>
                                  <div>{mt5AndDemoList.value?.swap}</div>
                                </Grid>
                                <Grid item md={6} className="accountInfoGrid">
                                  <div>
                                    <span className="fw-700">Commission</span>{" "}
                                  </div>
                                  <div>
                                    {mt5AndDemoList.value?.commission_amount}
                                  </div>
                                </Grid> */}
                                <Grid item md={6} className="accountInfoGrid">
                                  <div>
                                ...
                                {/* <Grid item md={6} className="accountInfoGrid">
                                  <div>
                                    <span className="fw-700">Real funds</span>{" "}
                                  </div>
                                  <div>{mt5AndDemoList.value?.mt_balance}</div>
                                </Grid> */}
                              </Grid>
                              <Grid container spacing={3}>
                                <Grid item md={12} className="text-center my-3">
