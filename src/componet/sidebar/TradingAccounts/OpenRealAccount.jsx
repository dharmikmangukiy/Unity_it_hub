          ...
          <Grid container>
            ...
            <Grid item xl={10} md={12} lg={12}>
              ...
              <Paper elevation={2} style={{ borderRadius: "10px" }}>
                ...
                >
                  <Card1 type={1} closePopup={setDOpen} refresh={setDrefresh} />
                  {/* <div
                  ...
                  >
                    ...
                    >
                      ...
                      <div
                        className={`acc-type-slide swiper-slide swiper-slide-${
                          num.pro ? (num.vip ? "next" : "prev") : "active"
                        }`}
                        onClick={() =>
                          setNum({
                            vip: false,
