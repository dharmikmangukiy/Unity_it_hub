  ...
  return (
    <div>
      <div className="px-md-5">
        ...
        >
          <Grid item md={12} lg={10} className="footer-section-control">
            <div className="app-footer text-black-50 p-3 px-md-5 py-md-4 app-footer--opacity-bg">
              ...
              <ol  className="footerstyle">
                <li>
                  ...
                  {/* {t("footerP1")} */}
                  Right Group is a group of companies which is registered under
                  number 26502 BC 2021 in SAINT VINCENT AND THE GRENADINES .
                  Authorised and regulated by the Financial Authorities.
                </li>
                <li>
                ...
                <p className="text-align-justify">
                  <b className="text-danger"> Risk Warning:</b> Forex and CFD trading involves a significant
                  risk to your invested capital. Please read and ensure you
                  fully understand our Risk Disclosure.
                </p>
                <p className="text-align-justify">
                <b className="text-danger">
                  Restricted Regions:</b> RightFX Limited does not provide services
                  for the residents of certain countries, such as the Israel and
              ...
              <div className="border-top pt-4 pb-4 d-md-flex justify-content-between copy-right text-blue-dark">
                ...
                <a href="https://www.facebook.com/OfficialRightFX/" target="_blank" className="ml-4 text-blue-dark">
                    <FacebookIcon />
                  </a>
                  <a href="https://twitter.com/FxRight" target="_blank" className="ml-4 text-blue-dark">
                    <TwitterIcon />
                  </a>

                  <a href="https://www.instagram.com/rightfxbroker/" target="_blank" className="ml-4 text-blue-dark">
                    <InstagramIcon />
                  </a>
                  <a href="https://wa.link/8xc9m7" target="_blank" className="ml-4 text-blue-dark">
                    <WhatsAppIcon />
                  </a>
                 
                  <a href="https://telegram.me/rightfx" target="_blank" className="ml-4 text-blue-dark">
                    <TelegramIcon />
                  </a>
                </div>
              </div>
